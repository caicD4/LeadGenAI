 ...
 * Adapted for LeadGenAI — tuned config matching Kinetic Boost aesthetic
 */
'use strict';
...
(function() {
    ...
    // Create a 1x1 dithering texture instead of loading an image
    let ditheringTexture = (() => {
        ...
        return { texture, width: 1, height: 1, attach(id) { gl.activeTexture(gl.TEXTURE0 + id); gl.bindTexture(gl.TEXTURE_2D, texture); return id; } };
    })();
    ...
    // Dimmed color generation matching Kinetic Boost aesthetic
